...
class AHT20:
    ...
    def __init__(self, BusNum=1, AHT_address=0x38):
        # Initialize AHT20
        self.BusNum = BusNum
        self.address = AHT_address
        self.cmd_soft_reset()
    ...
    def cmd_soft_reset(self):
        ...
        with SMBus(self.BusNum) as i2c_bus:
            i2c_bus.write_i2c_block_data(self.address, 0x0, AHT20_CMD_SOFTRESET)
    ...
    def cmd_initialize(self):
        ...
        with SMBus(self.BusNum) as i2c_bus:
            i2c_bus.write_i2c_block_data(self.address, 0x0 , AHT20_CMD_INITIALIZE)
        return True

    def cmd_measure(self):
        # Send the command to measure
        with SMBus(self.BusNum) as i2c_bus:
            i2c_bus.write_i2c_block_data(self.address, 0, AHT20_CMD_MEASURE)
    ...
    def get_status(self):
        ...
        with SMBus(self.BusNum) as i2c_bus:
            return i2c_bus.read_i2c_block_data(self.address, 0x0, 1)[0]
        return True
    ...
    def get_measure(self):
        ...
        with SMBus(self.BusNum) as i2c_bus:
            return i2c_bus.read_i2c_block_data(self.address, 0x0, 7)
